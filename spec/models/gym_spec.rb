...
RSpec.describe Gym, type: :model do
  it "should have many tickets" do
    ...
    context "the subtract_wait_bottom_floor method" do
        it "should check that subtract_wait_bottom_floor subtract 1 to wait_bottom_floor" do
            g = Gym.new(:name => "Trudy", :top_floor_occupancy => 0, :bottom_floor_occupancy => 2, :top_floor_capacity => 25, :bottom_floor_capacity => 20, :wait_top_floor => 0, :wait_bottom_floor => 2)
